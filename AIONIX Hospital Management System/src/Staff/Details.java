...
String duty;
    ...
    private void initComponents() {
        ...
        t.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Name", "Age", "Sex", "Phone No.", "Address", "Duty"
            }
        ) {
        ...
        jScrollPane2.setBounds(110, 370, 1160, 250);
        ...
        jButton3.setBounds(560, 640, 180, 50);

        jLabel22.setFont(new java.awt.Font("Rockwell", 2, 30)); // NOI18N
        jLabel22.setForeground(new java.awt.Color(255, 0, 0));
        jLabel22.setText("Select Duty to Search");
        jLabel22.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)));
        getContentPane().add(jLabel22);
        jLabel22.setBounds(320, 300, 320, 40);

        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Pics/Ditch-Go.png"))); // NOI18N
        getContentPane().add(jLabel3);
        jLabel3.setBounds(90, 0, 1280, 280);

        searchname.setFont(new java.awt.Font("Monospaced", 1, 14)); // NOI18N
        searchname.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "---------Select---------", "Nurse", "O.T. Incharge", "Wardboy" }));
        searchname.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)));
        ...
        searchname.setBounds(810, 300, 230, 40);
    ...
    private void searchnameActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_searchnameActionPerformed
        // TODO add your handling code here:
        duty=(String) searchname.getSelectedItem();
        if(duty.equals("-------------Select-------------"))
        {
            JOptionPane.showMessageDialog(rootPane, "Please Select a Duty to Search.");
        }
        else
        {
        try {
            ...
            String query="Select * from Staff where Duty='"+duty+"';";
            ...
            if(rs.first()==false) {
                ...
                while(rs.next()) {
                    ...
                    model.addRow(new Object[] {Name,Age,Sex,Phone,Address,Duty});
                }
            }
        } catch (Exception ex) {}}
